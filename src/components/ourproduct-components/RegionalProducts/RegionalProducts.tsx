...
const DesktopCard: React.FC<{ product: RegionalProduct; index: number }> = ({ product, index }) => (
  <>
...
const MobileCard: React.FC<{ product: RegionalProduct; index: number }> = ({ product }) => (
  <>
...
const RegionalProducts: React.FC<RegionalProductsProps> = ({ className = '' }) => {
  ...
  const maxIndex = Math.max(0, REGIONAL_PRODUCTS.length - 2); // Show 2 cards on mobile
  ...
  return (
    <section className={`${className}`}>
      ...
      <div className="bg-gray-900 py-16 lg:py-24">
        ...
        {/* Circular cards layout - Desktop: 6 cards, Mobile: draggable */}
        <div className="container mx-auto px-4">
          {isMobile ? (
            ...
            <div className="relative overflow-hidden">
              ...
              >
                {REGIONAL_PRODUCTS.map((product, index) => (
                  <motion.div
                    key={product.id}
            ...
            /* Desktop: All 6 cards in one line */
