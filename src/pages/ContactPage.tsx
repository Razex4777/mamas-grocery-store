                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div className="md:col-span-2">
                      <button
                        ...
                        className="bg-green-700 hover:bg-green-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold text-xs md:text-sm transition-colors flex items-center gap-2"
                      >
                        {isSubmitting ? (
                          <>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-5 md:p-8 mb-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="flex items-start gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <Mail className="w-4 h-4 md:w-5 md:h-5 text-green-700" />
                    </div>
                    <div>
                      <p className="text-xs md:text-sm text-gray-600 mb-1">Email</p>
                      <a href="mailto:mamasgroceryandbbq@gmail.com" className="text-sm md:text-base text-gray-900 font-medium hover:text-green-700 transition-colors break-all">
                        mamasgroceryandbbq@gmail.com
                      </a>
                    </div>
                  </div>
